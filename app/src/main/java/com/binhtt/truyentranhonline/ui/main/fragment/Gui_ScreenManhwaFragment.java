...
import static com.binhtt.truyentranhonline.ui.main.InitParams.URL_MANHWA_PAGE;
...
public class Gui_ScreenManhwaFragment extends BaseFragment {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (ConnectionUtil.isConnected(getContext())) {
                    new ScreenManhwaTask().execute(URL_MANHWA_PAGE);
                } else {
    ...
    public class ScreenManhwaTask extends AsyncTask<String, Void, ArrayList<Story>> {
        @Override
        ...
        protected void onPostExecute(final ArrayList<Story> stories) {
            ...
            mAdapter = new Gui_Screen2Adapter(getContext(), stories, new Gui_Screen2Adapter.OnClickStoryListener() {
                ...
                public void onItemClick(Story story, int position) {
                    Gui_Screen218PlusActivity_.intent(Gui_ScreenManhwaFragment.this).mStory(story).start();
                }
            });
