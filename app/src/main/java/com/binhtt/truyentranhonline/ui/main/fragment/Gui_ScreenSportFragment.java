...
import static com.binhtt.truyentranhonline.ui.main.InitParams.URL_SPORT;
...
public class Gui_ScreenSportFragment extends BaseFragment {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (ConnectionUtil.isConnected(getContext())) {
                    new ScreenSportTask().execute(URL_SPORT);
                } else {
    ...
    public class ScreenSportTask extends AsyncTask<String, Void, ArrayList<Story>> {
        @Override
        ...
        protected void onPostExecute(final ArrayList<Story> stories) {
            ...
            mAdapter = new Gui_Screen2Adapter(getContext(), stories, new Gui_Screen2Adapter.OnClickStoryListener() {
                ...
                public void onItemClick(Story story, int position) {
                    Gui_Screen218PlusActivity_.intent(Gui_ScreenSportFragment.this).mStory(story).start();
                }
            });
