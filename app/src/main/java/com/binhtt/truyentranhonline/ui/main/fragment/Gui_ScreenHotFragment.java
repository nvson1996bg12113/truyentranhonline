...
import static com.binhtt.truyentranhonline.ui.main.InitParams.URL_HOT_PAGE;
 ...
 * @since 17/08/2017
 */
public class Gui_ScreenHotFragment extends BaseFragment {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (ConnectionUtil.isConnected(getContext())) {
                    new ScreenHotTask().execute(URL_HOT_PAGE);
                } else {
    ...
    public class ScreenHotTask extends AsyncTask<String, Void, ArrayList<Story>> {
        @Override
        ...
        protected void onPostExecute(final ArrayList<Story> stories) {
            ...
            mAdapter = new Gui_Screen2Adapter(getContext(), stories, new Gui_Screen2Adapter.OnClickStoryListener() {
                ...
                public void onItemClick(Story story, int position) {
                    Gui_Screen218PlusActivity_.intent(Gui_ScreenHotFragment.this).mStory(story).start();
                }
            });
